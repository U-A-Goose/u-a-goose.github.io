...
<section class="team-shell">
  <div class="team-member-grid">
    ...
    <article class="team-panel team-member-card">
      <img src="assets/images/protrait_zipeng.jpg" alt="Portrait of Zipeng Ling" class="team-member-photo">
      <div class="team-member-body">
        <span class="team-eyebrow">MSc Student</span>
        <h3>Zipeng Ling</h3>
        <p class="team-role">
        ...
        <p class="team-links">
          <a href="mailto:zipeng6@ualberta.ca">Email</a>
          <a href="https://zpling.github.io/">Homepage</a>
        </p>
      </div>
    </article>
  </div>
...
<section class="team-shell">
  <div class="team-member-grid">
    ...
    <article class="team-panel team-member-card">
      <img src="assets/images/protrait_yuyang.jpg" alt="Portrait of Yuyang Wang" class="team-member-photo">
      <div class="team-member-body">
        <span class="team-eyebrow">Undergrad Student</span>
        <h3>Yuyang Wang</h3>
        <p class="team-role">
          <span>Undergrad Student, CS Department</span>
          <span>Joined May 2026</span>
        </p>

        <p class="team-links">
          <a href="mailto:yuyang31@ualberta.ca">Email</a>
        </p>
      </div>
    </article>

    <article class="team-panel team-member-card">
      <img src="assets/images/protrait_boyuan.jpg" alt="Portrait of Boyuan Sun" class="team-member-photo">
      <div class="team-member-body">
        <span class="team-eyebrow">Undergrad Student</span>
        <h3>Boyuan Sun</h3>
        <p class="team-role">
        ...
        <p class="team-links">
          <a href="mailto:bsun5@ualberta.ca">Email</a>
        </p>
      </div>
    </article>

    <article class="team-panel team-member-card">
      <img src="assets/images/protrait_xingan.jpg" alt="Portrait of Xingan Gao" class="team-member-photo">
      <div class="team-member-body">
        <span class="team-eyebrow">CSC Joint PhD Student</span>
        <h3>Xingan Gao</h3>
        <p class="team-role">
          <span>CSC Joint PhD Student, CS Department</span>
          <span>Joined Sep 2026</span>
        </p>

        <p class="team-links">
          <a href="mailto:DX120250116@stu.yzu.edu.cn">Email</a>
        </p>
      </div>
    </article>
  </div>
...
## Hall of Honor (IRCC Delayed Students)
...
<section class="team-shell">
  <div class="team-member-grid">
    <article class="team-panel team-member-card">
      ...
      <div class="team-member-body">
        <span class="team-eyebrow">Hall of Honor</span>
        <h3>Geng He</h3>
        <p class="team-role">
          <span>Now Research Engineer@SMU</span>
          <span>Co-Advised w/ Prof. David Lo</span>
        </p>
      </div>
    </article>
    ...
    <article class="team-panel team-member-card">
      ...
      <div class="team-member-body">
        ...
        <p class="team-role">
          <span>Now PhD Student@Korea University</span>
          <span>Co-Advised w/ Prof. Dongsun Kim</span>
        </p>
      </div>
    </article>
  ...
  <div class="team-panel team-join-card">
    ...
    <p class="team-links">
      <a href="openings.html">View openings</a>
    </p>
  </div>
</section>
```
