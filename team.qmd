...
<section class="team-shell">
  <div class="team-member-grid">
    ...
    <article class="team-panel team-member-card">
      <img src="assets/images/goose_2.png" alt="Goose avatar placeholder for Jingfeng Jiang" class="team-member-photo team-member-photo--avatar">
      <div class="team-member-body">
        <span class="team-eyebrow">Incoming</span>
  ...
  <div class="team-member-grid">
    <article class="team-panel team-member-card">
      ...
      <div class="team-member-body">
        ...
        <p class="team-role">
          <span>MSc by Thesis, CS Department</span>
          <span>Incoming (Sep 2026)</span>
        </p>
        <p class="team-links">
...
<section class="team-shell">
  <div class="team-member-grid">
    <article class="team-panel team-member-card">
      ...
      <div class="team-member-body">
        <span class="team-eyebrow">MSc by Course</span>
        <h3>Zixi Chai</h3>
        <p class="team-role">
          <span>MSc by Course, ECE Department</span>
          <span>Joined Jan 2026</span>
        </p>
